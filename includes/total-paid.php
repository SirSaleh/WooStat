<?php
function get_total_paid($order_id,$product_name){
	global $wpdb;
	...
	//echo("dump: ".$item_id[0]);
	$consulta2 = "SELECT meta_value FROM {$wpdb->prefix}woocommerce_order_itemmeta WHERE order_item_id=".$item_id[0]." AND meta_key = '_line_subtotal';";
