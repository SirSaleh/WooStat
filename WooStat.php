...
function WooStat_Page() {
	...
	if ( class_exists( 'WooCommerce' ) ) {
		...
		//var_dump($loop);
		if ( $loop->have_posts() ) {
			echo ("<table><tr><td style='border: 1px solid black;' >Product Name</td><td style='border: 1px solid black;' >Product Id</td><td style='border: 1px solid black;' >Count of the orders</td><td style='border: 1px solid black;' >Total Counts of orders</td><td style='border: 1px solid black;' >Total Paid for orders</td></tr>");
						...
						if ($ord->have_posts()){
							while($ord->have_posts()){
								...
								if ($ord->post->post_status == "wc-completed"){
									...
									$total_paid = $total_paid + get_total_paid($ord->post->ID,$loop->post->post_title) ;
									$sum++;
								}
							}
							...
							echo ("<th style='border-left: 1px solid black;' >0</th><th style='border-left: 1px solid black;' >0</th><th style='border-left: 1px solid black;' >0</th>");
						}
